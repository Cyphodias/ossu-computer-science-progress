# 📘 OSSU Computer Science Progress Tracker

> My public record of working through the [Open Source Society University (OSSU) Computer Science curriculum](https://github.com/ossu/computer-science), while building a deeper research track in Computer Science, Mathematics, AI and Machine Learning.
...
## 📊 Current Status — 12 August 2026

| Area | Status |
| --- | --- |
| OSSU Computer Science | 🟡 In progress |
| Programming foundations | 🟡 In progress |
| Mathematics foundations | 🟡 In progress |
| Algorithms & data structures | 🟡 In progress |
| Computer systems | 🟡 In progress |
| AI / Machine Learning | 🟡 Building foundations |
...
The main path remains **OSSU Computer Science**. Alongside it, I am building a research-oriented reading track connecting Computer Science, Mathematics and modern AI.
...
- [x] Create a public learning repository
...
### Phase 5 — Applications & Software Engineering
...
### Phase 8 — Final Project & Research

- [ ] Complete OSSU requirements
- [ ] Build substantial final project
- [ ] Develop a research-quality project
- [ ] Publish technical documentation
- [ ] Continue into advanced research literature
